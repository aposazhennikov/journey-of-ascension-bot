...
def practice_note(point_index: int, language: str) -> str:
    notes = {
        ...
        "ru": (
            "Начните только с этой точки. Найдите её по изображению, попробуйте зацепиться за неё вниманием. Если ощущение слабое или вообще не получается почувствовать точку, попробуйте помассировать эту точку, мягко надавите пальцем на эту область, попробуйте круговые движения по часовой и против часовой стрелке, понаблюдайте, как приятнее. Когда появилось первичное ощущение, начните представлять дыхание через точку, визуализируйте, как вы делаете вдох света через эту точку и выдох, синхронизируйте с реальным дыханием. Вы должны не только представить образ, но и почувствовать некое ощущение освобождения этой точки. Хорошим результатом будет, если вы сможете «зацепиться» за точку вниманием без напряжения и специального действия: появилось намерение почувствовать точку — и вы мгновенно почувствовали.\n\nПродолжайте делать так, пока вниманию не станет легче удерживаться здесь. Продолжайте чувствовать точку.\n\nДобейтесь устойчивого ощущения и можете переходить к следующей точке.",
...
def format_setup_complete_preview(language: str) -> str:
    lines = {
        "en": (
            ...
            "📅 Quiet days: None",
            "Your rhythm now has two layers: an ethical focus for the day and a body focus through meridians. Let them support each other: less wasted energy, more attention in the body.",
        ...
        "ru": (
            ...
            "📅 Дни тишины: Нет",
            "Теперь у ритма два слоя: нравственный фокус дня и телесный фокус через меридианы. Пусть они поддерживают друг друга: меньше слитой энергии, больше внимания в теле.",
        ...
        "uz": (
            ...
            "📅 Sokin kunlar: Yo'q",
            "Endi ritm ikki qatlamdan iborat: kunning axloqiy fokusi va meridianlar orqali tana fokusi. Ular bir-birini qo'llasin: kamroq energiya yo'qotish, tanada ko'proq diqqat.",
        ...
        "kz": (
            ...
            "📅 Тыныш күндер: Жоқ",
            "Енді ырғақ екі қабаттан тұрады: күннің этикалық фокусы және меридиандар арқылы дене фокусы. Олар бірін-бірі қолдасын: энергия аз шашылсын, денеде зейін көбейсін.",
